...
const prepareData = (startDatas: StartData[], stays: BookingWithGuestLastName[]): StartData[] => {
  // A bit ugly code, but sometimes this is what it takes when working with real data 😅

  const incArrayValue = (arr: StartData[], field: string): StartData[] => {
...
export type DurationChartProps = {
  confirmedStays: BookingWithGuestLastName[];
};

export const DurationChart = (props: DurationChartProps): ReactElement => {
  const { confirmedStays } = props;
